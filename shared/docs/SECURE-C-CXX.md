...
Repositories generated from this template inherit `AES-SEC-001: Secure C and C++ Coding Rules` from the Atarix Engineering Standard.

No new C or C++ code should be accepted unless it follows the AES secure-coding profile.

## Required Local Behavior

If the generated repository contains or later accepts C/C++ code, that code must:
